...
const CTASection = () => {
  return (
    <div className='flex flex-col p-[2rem] w-[100%] max-w-[100vw] gap-[var(--custom-gap)] bg-[var(--faint-blue-background)] sm:flex-row sm:justify-around sm:gap-0 sm:px-[4rem]'>
