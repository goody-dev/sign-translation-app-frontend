...
const ContactUs = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    await fetch ('POST', 'https://sign.onrender')
  ...
  return (
    <div id='contact-section' className='flex flex-col gap-[var(--custom-gap)] w-[100%] max-w-[100vw] py-[3rem] px-[1.5rem] sm:p-[var(--custom-padding)] bg-[#F3F4FF] sm:flex-row sm:flex-wrap sm:gap-0 '>
      ...
      <form name='Contact Form' onSubmit={(event)=>handleSubmit(event)} className='flex flex-col gap-[var(--custom-gap)] w-[100%] bg-[var(--white-background)] p-[var(--card-padding)] px-[4.75rem] rounded-[var(--custom-radius)] sm:w-[50%]'>
