      ...
      <div className='flex flex-row gap-[2.5rem] w-[100%]'>
        ...
        <div className='flex flex-col gap-[var(--custom-gap)] w-[100%] sm:w-[50%]'>
          ...
          <div className='flex flex-row justify-between'>
            ...
            <button className='bg-[var(--blue-background)] p-[var(--button-padding)] rounded-[0.5rem] text-[var(--tertiary-color)] font-semibold shadow-[var(--button-shadow)] gap-[var(--inline-gap)] sm:p-[var(--button-padding)]'>Next <img className='h-[var(vh-icon)]' src={ArrowIcon} /></button>
          </div>
        </div>
      </div>
    </div>
